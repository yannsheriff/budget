...
export default function ConfirmBanner({ monthId, expenses, onUpdate }: Props) {
  ...
  return (
    <div className="bg-amber-50 dark:bg-amber-500/10 border border-amber-200 dark:border-amber-500/20 rounded-xl px-4 py-3 mb-5 flex items-center justify-between">
      ...
      <button
        ...
        className="bg-emerald-50 dark:bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 hover:bg-emerald-100 dark:hover:bg-emerald-500/20 px-3 py-1.5 rounded-lg text-xs font-semibold transition-colors"
      >
        Tout confirmer
      </button>
    </div>
