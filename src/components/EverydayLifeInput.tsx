    ...
    <div className="mb-4 bg-gray-50 dark:bg-zinc-800/40 border border-gray-200 dark:border-zinc-700/50 rounded-xl overflow-hidden">
      ...
      {open && (
        <>
          ...
          <div className="flex items-center gap-2 px-4 py-2.5 text-[13px] text-gray-500 dark:text-zinc-500 border-t border-gray-200 dark:border-zinc-700/50">
            {formatEur(numValue)}/sem × {weeks} semaines ={" "}
            <span className="text-gray-900 dark:text-zinc-200 font-bold text-[15px] ml-1">
              {formatEur(total)}
            </span>
          </div>
        </>
